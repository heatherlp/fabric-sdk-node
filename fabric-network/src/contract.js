...
class Contract {
	constructor(network, chaincodeId, namespace, collections) {
		...
		this.contractListeners = new Map(); // TODO: should this just be called Listeners? not contract.contractListeners
	}
	...
	async addContractListener(listener) {
		// TODO: Takes a blockListener? should take a contractListener, what does that look like?
